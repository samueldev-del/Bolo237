  ...
  const faqItems: FaqItem[] = [
    {
      question: isEn
        ...
        : 'Comment vérifier le profil d’un prestataire sur Bolo237 ?',
      answer: isEn
        ...
        : 'Le prestataire soumet une pièce d’identité et un selfie via Identity Shield. Notre équipe vérifie manuellement le dossier avant d’afficher le badge vérifié.',
    },
    {
      question: isEn
      ...
      answer: isEn
        ...
        : 'Oui. La publication d’une offre sur Bolo237 est gratuite pour les employeurs et les prestataires à ce stade.',
    },
    {
      question: isEn
        ? 'Can I use Bolo237 without downloading an app?'
        : 'Puis-je utiliser Bolo237 sans télécharger une application ?',
      answer: isEn
        ? 'Yes. Bolo237 works directly in your browser and can be installed as a PWA if you want.'
        : 'Oui. Bolo237 fonctionne directement dans votre navigateur et peut être installée en PWA si vous le souhaitez.',
    },
    {
      question: isEn
      ...
      answer: isEn
        ...
        : 'Non. Bolo237 est une plateforme intermédiaire. Les accords sont conclus directement entre utilisateurs.',
    },
  ];
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-12 md:py-16">
        ...
        <p className="text-gray-600 mb-8">
          {isEn
            ...
            : 'Tout ce qu’il faut savoir sur la vérification, la publication et la confiance sur Bolo237.'}
        </p>
