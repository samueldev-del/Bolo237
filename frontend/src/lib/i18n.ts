...
export const dictionary = {
  fr: {
    header: {
      ...
      review: 'Revue',
      myAccount: 'Mon 237job',
      savedJobs: 'Emplois sauvegardés',
      applications: 'Candidatures',
      createCv: 'Créer un CV',
      topEmployers: 'Meilleurs employeurs',
      topArtisans: 'Meilleurs artisans',
      interviewPrep: "S'entraîner aux entretiens",
      current: 'Actuel',
      signIn: 'Se connecter',
      signUp: "S'inscrire",
      postNow: 'Publier une annonce',
      salary: 'Salaire',
      careerInsights: 'Carrière',
      workLife: 'Vie professionnelle',
    },
    footer: {
