...
export const dictionary = {
  fr: {
    ...
    footer: {
      ...
      follow: 'Suivez-nous',
      feedback: 'Partagez vos retours avec notre équipe.',
      contact: 'Contact',
      whatsappSupport: 'Assistance 24 h/24, 7 j/7',
    ...
    security: {
      ...
      sendReport: 'Transmettre le signalement',
      alreadyReported: 'Signalement déjà transmis depuis cet appareil',
      reportSubmitted: 'Signalement transmis à notre équipe de modération.',
      reportError: 'Impossible d’envoyer le signalement pour le moment.',
      uniqueReports: 'signalement(s) ouverts. Vérification renforcée à partir de 3.',
      autoMaskedAd: 'Cette annonce est temporairement limitée après plusieurs signalements et reste en cours de vérification par l’équipe Bolo237.',
      autoMaskedArtisan: 'Ce profil artisan est temporairement limité après plusieurs signalements et reste en cours de vérification par l’équipe Bolo237.',
  ...
  en: {
    ...
    security: {
      ...
      alreadyReported: 'Report already sent from this device',
      reportSubmitted: 'Report sent to our moderation team.',
      reportError: 'Unable to send the report right now.',
      uniqueReports: 'open report(s). Escalated review starts at 3.',
      autoMaskedAd: 'This listing is temporarily limited after multiple reports and is pending review by the Bolo237 team.',
      autoMaskedArtisan: 'This artisan profile is temporarily limited after multiple reports and is pending review by the Bolo237 team.',
